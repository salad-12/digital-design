...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.75\columnwidth]{./figs/Atmega168PinMap2}
\end{center}
\caption{}
\label{fig:Atmega168PinMap2}
\end{figure}
%
\item Plug the seven segment display in Fig. \ref{fig:sevenseg} into the breadboard.
\begin{figure}[H]
\begin{center}
...
\label{fig:sevenseg}
\end{figure}
\item Connect 5V from the Arduino to the the COM pin of the display through a resistor.
...
\end{table}
%\item Connect the arduino to the seven segment display according to \cite{gvv_ard_assembly_sevenseg}.
...
%\begin{figure}[H]
%\begin{center}
%\includegraphics[width=0.75\columnwidth]{./figs/breadboard}
%\end{center}
%\caption{}

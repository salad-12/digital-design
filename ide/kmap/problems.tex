...
%
\item \figref{fig:2020/gate/ec/10} below shows a muliplexer where S0 and S1 are the select lines, I0 to I3 are the input lines, EN is the enable line and F(P,Q,R) is the output. Find the boolean expression for output F as function of inputs P,Q,R using K-map. 
\hfill (GATE EC 2020)
%
\label{prob:2020/gate/ec/10}
\begin{figure}[H]
\centering
	\includegraphics[width=0.75\columnwidth]{figs/2020-gate-ec-10.png}
\caption{}
...
\begin{figure}[H]
\centering
	\includegraphics[width=0.75\columnwidth]{figs/1992-gate-ec-1-22.png}
\caption{}
...
\item
	...
	The output expression for the Karnaugh map shown below in
                        \figref{fig:kmap}
is
                \hfill(GATE EE 2019)
        \begin{figure}[H]
...
\item In the circuit shown below in 
	\figref{fig},
	 X and Y are digital inputs, and Z is a digital output. The quivalent 
		circuit is a  
		\hfill(GATE EE 2019)
...
\end{figure}
	...
	The output F of the digital circuit shown 
	in
		\figref{figure}
	can be written in the form(s)\rule{2cm}{0.4pt}
	\hfill(GATE IN 2022)
	\begin{figure}[H]
		\centering
		\resizebox{0.75\columnwidth}{!}{%
...
\figref{prob:gate  ec2023,23 },
	 P and Q are the inputs. The logical function realized by the circuit shown below in 
\figref{prob:gate  ec2023,23 }
is
\begin{figure}[H]
\centering
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.75\columnwidth]{ide/kmap/figs/gate23_ph24.jpg}
        \caption{k-maps}
...
\item
	 ...
	 \begin{figure}[H]
		 \centering
		\includegraphics[width=0.75\columnwidth]{figs/gatepic19.jpg}
		\caption{MUX}
		 \label{fig:MUX}
	\end{figure}
	 \begin{enumerate}[label=(\Alph*)]

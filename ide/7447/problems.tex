...
\begin{figure}[H]
\centering
	\includegraphics[width=0.75\columnwidth]{figs/2010-gate-ec-39.png}
\caption{}
...
\begin{figure}[H]
\centering
	\includegraphics[width=0.75\columnwidth]{figs/2017-gate-ec-16.png}
\caption{}
...
\item Select the Boolean function(s) equivalent to $x + yz$, where $x,y$, and $z$ are Boolean variables, and + denotes logical OR  operation.\hfill(GATE EC 2022)
 ...
 \item Which one of the following options is CORRECT for the given circuit 
	 ...
	 \hfill(GATE PHYSICS 2023)
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.75\columnwidth]{figs/Q24.jpg}
			\caption{}
			\label{fig:xxxx}
		\end{figure}

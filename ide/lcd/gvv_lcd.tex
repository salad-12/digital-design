...
%\title{
%	\logo{Matrix Analysis through Octave}{\begin{center}\includegraphics[width=0.75\columnwidth]{tlc}\end{center}}{}{HAMDSP}
%}
...
\begin{figure}
\centering
\includegraphics[width=0.75\columnwidth]{./figs/breadboard.eps}
\caption{Breadboard}
...
\begin{figure}
\centering
%\includegraphics[width=0.75\columnwidth]{./figs/voltage_divider.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.75\columnwidth]{./figs/lcd.eps}
\caption{lcd}
\label{fig:lcd}
\end{figure}
%

...
\item 
\begin{lstlisting}
sudo apt-get install avra avrdude platformio neovim
\end{lstlisting}
...
\item 
\begin{lstlisting}
svn co https://github.com/gadepall/arduino/trunk/assembly/piosetup/codes/hi
cd hi
\end{lstlisting}
\item In \textbf{hello.asm} replace \textbf{gadepall} in 
\begin{lstlisting}
.include "/home/gadepall/m328Pdef.inc"
\end{lstlisting}
with your username. save and exit
\item 
\begin{lstlisting}
avra hello.asm
mv hello.hex .pio/build/uno/
pio run -t nobuild -t upload
\end{lstlisting}
%\item 
%	%Open \textbf{hello.asm} in \textbf{geany}. Go to Build$\rightarrow$Set Build Commands$\rightarrow$Compile and type
%\begin{lstlisting}
%\end{lstlisting}
%\item Then  go to Build$\rightarrow$Set Build Commands$\rightarrow$Execute and type
%\begin{lstlisting}
%avrdude -p atmega328p -c arduino -P /dev/ttyACM0 -b 115200 -U flash:w:%e.hex
%\end{lstlisting}
\item Compile by pressing \textbf{F8}. Execute by pressing \textbf{F5}.  You should
